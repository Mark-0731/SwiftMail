...
import (
	...
	"github.com/Mark-0731/SwiftMail/internal/features/suppression"
	"github.com/Mark-0731/SwiftMail/internal/features/suppression/infrastructure"
...
func NewService(repo infrastructure.Repository, rdb *redis.Client, logger zerolog.Logger) *Service {
...
func (s *Service) List(ctx context.Context, userID uuid.UUID, page, perPage int) ([]suppression.Entry, int64, error) {
