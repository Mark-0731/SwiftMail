...
type Repository interface {
	...
	List(ctx context.Context, userID uuid.UUID, page, perPage int) ([]suppression.Entry, int64, error)
}
...
func (r *PostgresRepository) List(ctx context.Context, userID uuid.UUID, page, perPage int) ([]suppression.Entry, int64, error) {
	var total int64
