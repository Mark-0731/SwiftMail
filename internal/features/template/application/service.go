...
import (
	...
	"github.com/Mark-0731/SwiftMail/internal/features/template/infrastructure"
...
type Service interface {
	Create(ctx context.Context, userID uuid.UUID, req *CreateTemplateRequest) (*template.Model, error)
	List(ctx context.Context, userID uuid.UUID) ([]template.Model, error)
	Get(ctx context.Context, id uuid.UUID) (*template.Model, error)
	Update(ctx context.Context, id uuid.UUID, req *UpdateTemplateRequest) (*template.Model, error)
	...
	Duplicate(ctx context.Context, id, userID uuid.UUID) (*template.Model, error)
...
func NewService(repo infrastructure.Repository, logger zerolog.Logger) Service {
	return &service{repo: repo, logger: logger}
}

func (s *service) Create(ctx context.Context, userID uuid.UUID, req *CreateTemplateRequest) (*template.Model, error) {
	t := &template.Model{
		UserID:      userID,
		Name:        req.Name,
...
func (s *service) List(ctx context.Context, userID uuid.UUID) ([]template.Model, error) {
	return s.repo.GetByUserID(ctx, userID)
}

func (s *service) Get(ctx context.Context, id uuid.UUID) (*template.Model, error) {
	return s.repo.GetByID(ctx, id)
}

func (s *service) Update(ctx context.Context, id uuid.UUID, req *UpdateTemplateRequest) (*template.Model, error) {
...
func (s *service) GetVersions(ctx context.Context, templateID uuid.UUID) ([]template.Version, error) {
...
func (s *service) Duplicate(ctx context.Context, id, userID uuid.UUID) (*template.Model, error) {
...
func (s *service) GetActiveVersion(ctx context.Context, templateID uuid.UUID) (*template.Version, error) {
