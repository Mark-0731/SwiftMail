...
import (
	"github.com/Mark-0731/SwiftMail/internal/features/webhook"
...
func NewHandler(repo *infrastructure.Repository, dispatcher *application.Dispatcher) *Handler {
...
func (h *Handler) Create(c *fiber.Ctx) error {
	...
	var body webhook.CreateRequest
