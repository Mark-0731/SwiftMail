...
type Repository interface {
	Create(ctx context.Context, d *domainmgmt.Model) error
	GetByID(ctx context.Context, id uuid.UUID) (*domainmgmt.Model, error)
	GetByUserID(ctx context.Context, userID uuid.UUID) ([]domainmgmt.Model, error)
	GetByDomain(ctx context.Context, userID uuid.UUID, domain string) (*domainmgmt.Model, error)
	Update(ctx context.Context, d *domainmgmt.Model) error
...
func (r *PostgresRepository) Create(ctx context.Context, d *domainmgmt.Model) error {
...
func (r *PostgresRepository) GetByID(ctx context.Context, id uuid.UUID) (*domainmgmt.Model, error) {
	d := &domainmgmt.Model{}
...
func (r *PostgresRepository) GetByUserID(ctx context.Context, userID uuid.UUID) ([]domainmgmt.Model, error) {
...
func (r *PostgresRepository) GetByDomain(ctx context.Context, userID uuid.UUID, domain string) (*domainmgmt.Model, error) {
	d := &domainmgmt.Model{}
	err := r.db.QueryRow(ctx,
		`SELECT id, user_id, domain, status, spf_record, dkim_public_key, dkim_private_key_encrypted, dkim_selector, dmarc_record,
...
func (r *PostgresRepository) Update(ctx context.Context, d *domainmgmt.Model) error {
	_, err := r.db.Exec(ctx,
