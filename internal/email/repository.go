...
func (r *PostgresRepository) UpdateStatus(ctx context.Context, id uuid.UUID, from, to string, smtpResponse *string) error {
...
func (r *PostgresRepository) SetOpened(ctx context.Context, id uuid.UUID) error {
	_, err := r.db.Exec(ctx,
...
func (r *PostgresRepository) SetClicked(ctx context.Context, id uuid.UUID) error {
	_, err := r.db.Exec(ctx,
